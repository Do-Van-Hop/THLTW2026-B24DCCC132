...
export const defaultDestinations: Destination[] = [
  ...
  },
  {
    ...
    id: '6',
    name: 'Thái Bình',
    image: 'https://media-cdn-v2.laodong.vn/Storage/NewsPortal/2022/10/2/1100180/Bien-Vo-Cuc-Haf-Lee.jpg',
    location: 'Thái Bình',
    type: 'thành phố',
    rating: 5.0,
    price: 200000,
    description: 'Quê lúa Thái Bình',
    visitDuration: 3,
    foodCost: 100000,
    accommodationCost: 500000,
    transportCost: 200000,
    ...
    id: '7',
    name: 'Hải Phòng',
    image: 'https://tuoitrethudo.com.vn/stores/news_dataimages/2022/112022/24/15/nhung-dau-an-hp-420221124153452.jpg?rt=20221124153456',
    location: 'Hải Phòng',
    type: 'thành phố',
    rating: 4.4,
    price: 300000,
    ...
    rating: 4.4,
    price: 600000,
    description: 'Vùng cao nguyên đá',
    visitDuration: 3,
    foodCost: 500000,
    accommodationCost: 700000,
